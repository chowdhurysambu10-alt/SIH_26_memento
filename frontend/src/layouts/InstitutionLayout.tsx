...
export const InstitutionLayout: React.FC<InstitutionLayoutProps> = ({
  ...
  return (
    <div className="portal-layout-container">
      {/* Desktop Sidebar */}
      <aside className={`portal-desktop-sidebar institution-sidebar ${isSidebarOpen ? 'expanded' : 'collapsed'}`}>
        <div className="sidebar-brand-header">
          {isSidebarOpen && (
            <div className="sidebar-brand-title">
              <Building2 size={20} color="#a78bfa" />
              <span>
                Memento<span style={{ color: '#a78bfa' }}>.org</span>
              </span>
            </div>
          )}
          <button
      ...
      <main className="portal-main-area">
        <header className="portal-topbar">
          ...
          <div className="portal-topbar-right">
            ...
            >
              <Bell size={18} />
              {unreadCount > 0 && <span className="topbar-badge-dot" style={{ background: '#8b5cf6' }} />}
            </button>
            <div className="portal-user-profile-summary">
              <div className="portal-user-text">
                <div className="portal-user-name">{user?.name || 'Institution'}</div>
                <div className="portal-user-role">Innovation Lab</div>
              </div>
              <div className="portal-user-avatar institution-avatar">
      ...
      >
        <div className="mobile-drawer-sheet open institution-drawer" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="drawer-nav-sections">
            <div className="drawer-section-title">Institution Workspace</div>
